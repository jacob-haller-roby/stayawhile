...
class ActiveRoomOwner extends React.Component {
    ...
    render() {
        return (
            <Grid container style={{display: 'flex', flex: 1, flexDirection: 'column'}} spacing={3}>
                            ...
                            return (
                                <Grid item xs={12} sm={6} lg={3}>
                                    <Card raised={isPlaying}
                                        ...
                                        <CardActions>
                                            <IconButton onClick={this.playlistPhraseDialogOpen.bind(this, playlist)}
                                                        edge="end">
                                                <Chat/>
                                            </IconButton>
                                            <div style={{flexGrow: 1}}/>
                                            <IconButton onClick={this.props.playPlaylist.bind(this, playlist.id)}
                                                        disabled={isPlaying}>
                                                <PlayArrow
                                                    style={{color: isPlaying ? 'yellowgreen' : 'rgba(0, 0, 0, 0.54)'}}/>
                                            </IconButton>
                                        </CardActions>
                                    </Card>
                                </Grid>
